...
#     k_arr = [16, 64, 128, 256]
    ...
    naiive_unlearn_kwargs = {'batch_size': 16}
    ...
    dataset2 = datasets.ImageFolder(valdir, 
                       transform=transform)
    ...
    for unlearn_k in k_arr:
        ...
        save_file_name = 'imagenet_new_unlearning_label_mix_resnet50_unlearning_lr_' + str(args.unlearn_lr) + '_reg_lamb_' + str(args.reg_lamb) + '_num_adv_images_' + str(args.num_adv_images) + '_l2_pgd_eps_' + str(args.pgd_eps) + '_iter_' + str(args.pgd_iter) + '_alpha_' + str(args.pgd_alpha) + '_seed_' + str(args.seed)
